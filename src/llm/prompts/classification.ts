...
3. **Payloads**: The JSON schema requires all payload keys to be present. You MUST ONLY populate the keys corresponding to your tag, ALONG WITH a 'summary', and set ALL OTHER payload keys to null. The 'summary' must ALWAYS be provided and should be a concise memory (1-2 sentences) of this context point to actively guide future styling sessions.
   - For \`session_state:occasion\`: \`{ "occasion": "...", "summary": "...", "constraint": null, "type": null, "preference": null, "url": null }\`
   - For \`session_state:constraint\`: \`{ "constraint": "...", "type": "footwear" | "color" | "style" | "other", "summary": "...", "occasion": null, "preference": null, "url": null }\`
   - For \`session_state:user_prefs\`: \`{ "preference": "...", "summary": "...", "occasion": null, "constraint": null, "type": null, "url": null }\`
   - For \`session_state:primary_outfit_image\` and \`session_state:alt_outfit_image\`: \`{ "url": "...", "summary": "...", "occasion": null, "constraint": null, "type": null, "preference": null }\`
...
- User: "I'm going to a summer wedding and need to look sharp but stay cool."
  Output: [
    {"tag": "session_state:occasion", "payload": {"occasion": "Summer Wedding", "summary": "User needs an outfit for a sharp summer wedding.", "constraint": null, "type": null, "preference": null, "url": null}},
    {"tag": "session_state:constraint", "payload": {"constraint": "Stay cool / Breathable", "type": "style", "summary": "Outfit must be breathable and cool.", "occasion": null, "preference": null, "url": null}}
  ]
- User: "I prefer darker colors and really like the second option."
  Output: [
    {"tag": "session_state:user_prefs", "payload": {"preference": "Darker colors", "summary": "User has a strong preference for darker colors.", "occasion": null, "constraint": null, "type": null, "url": null}},
    {"tag": "session_state:alt_outfit_image", "payload": {"url": "...", "summary": "User highly liked the second outfit image.", "occasion": null, "constraint": null, "type": null, "preference": null}}
  ]
