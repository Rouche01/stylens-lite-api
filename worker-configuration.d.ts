/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17a5d790759182b41b111b604ce022ef)
// Runtime types generated with workerd@1.20260401.1 2025-10-11 
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		GOSTYLENS_DB: D1Database;
		IMAGES: ImagesBinding;
		ENV_NAME: "staging";
		OPENAI_MODEL_ENDPOINT_URL: string;
		OPENAI_MODEL_API_KEY: string;
		OPENAI_STYLE_ANALYSIS_MODEL_VERSION: string;
		OPENAI_OUTFIT_EXTRACTION_MODEL_VERSION: string;
		OPENAI_FAST_TASK_MODEL_VERSION: string;
		CLAUDE_ENDPOINT_URL: string;
		CLAUDE_API_KEY: string;
		CLAUDE_STYLE_ANALYSIS_MODEL_VERSION: string;
		CLAUDE_OUTFIT_EXTRACTION_MODEL_VERSION: string;
		CLAUDE_FAST_TASK_MODEL_VERSION: string;
		OUTFIT_PHOTOS_BUCKET_ACCESS_KEY_ID: string;
		OUTFIT_PHOTOS_BUCKET_SECRET_ACCESS_KEY: string;
		OUTFIT_PHOTOS_BUCKET_API_TOKEN: string;
		OUTFIT_PHOTOS_BUCKET_NAME: string;
		...
		FREE_TIER_TRIAL_DAYS: string;
		FREE_TIER_TRIAL_SESSION_LIMIT: string;
		FREE_TIER_MONTHLY_SESSION_LIMIT: string;
		FREE_TIER_MESSAGE_PER_SESSION_LIMIT: string;
		FREE_TIER_IMAGE_PER_SESSION_LIMIT: string;
		CLOUDFLARE_DEPLOYER_ACCOUNT_ID: string;
		CLOUDFLARE_DEPLOYER_TOKEN: string;
	...
	interface Env {
		...
		GOSTYLENS_DB: D1Database;
		IMAGES: ImagesBinding;
		ENV_NAME: "staging" | "production" | "dev";
		OPENAI_MODEL_ENDPOINT_URL: string;
		OPENAI_MODEL_API_KEY: string;
		OPENAI_STYLE_ANALYSIS_MODEL_VERSION: string;
		OPENAI_OUTFIT_EXTRACTION_MODEL_VERSION: string;
