/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 807d34ba1b2962d159bf22be25409d10)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		OUTFIT_EXTRACTION_MODEL: string;
		OUTFIT_EXTRACTION_MODEL_ENDPOINT: string;
		OUTFIT_EXTRACTION_MODEL_API_KEY: string;
		SUPABASE_URL: string;
